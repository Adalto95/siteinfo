                    ...
                    {downloadItems.map((item, index) => (
                        ...
                        >
                            <a
                                ...
                                className="flex items-center justify-between p-4 bg-white rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-l-4 border-sky-500"
                            >
                                <span className="font-semibold text-gray-800">{item.name}</span>
                                <DownloadCloud className="w-6 h-6 text-sky-500" />
                            </a>
                        </motion.div>
                    ))}
                </div>
